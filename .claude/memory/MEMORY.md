...
- [Guards that slice YAML text never converge — extract the logic](extract-logic-out-of-workflow-yaml.md) - Three rounds each narrowed a text slice and the defect moved one indent out; extraction ended it in two
